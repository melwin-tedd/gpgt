...
function Button({ children, href, active }: Button) {
  return (
    <Link
      href={href}
      className="group relative inline-flex items-center justify-start overflow-hidden rounded-md bg-gray-50 px-6 py-3 font-bold text-green-900 transition-all duration-150 ease-in-out focus:outline-green-600 "
    >
      <span
