...
function SliderCard({ data }: Props) {
  return (
    <motion.div
      className="relative h-36 min-w-[250px] rounded-2xl border-[1px] shadow-md md:h-80 md:min-w-[208px]"
      layout
    ...
    >
      <motion.img
        ...
        src={data.img}
        className="absolute aspect-video h-full w-full rounded-2xl object-cover brightness-75 hover:brightness-100"
      />
